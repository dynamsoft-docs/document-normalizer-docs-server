...
- [`RasterDataSource`]({{ site.enumerations }}core/raster-data-source.html?src=cpp&&lang=cpp)
...
- [`TransformMatrixType`]({{ site.enumerations }}core/transform-matrix-type.html?src=cpp&&lang=cpp)
