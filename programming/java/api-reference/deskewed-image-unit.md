...
description: API reference for the DeskewedImageUnit class in Dynamsoft Document Normalizer Java Edition, which represents an intermediate result unit containing deskewed document images.
