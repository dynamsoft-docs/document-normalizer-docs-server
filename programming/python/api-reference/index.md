...
title: Dynamsoft Document Normalizer Python Edition API Reference - Main Page
description: This is the main page of Dynamsoft Document Normalizer SDK API Reference for Python Edition.
keywords: CDocumentNormalizer, api reference, python
---
...
- [`EnumImageColourMode`]({{ site.dcv_enumerations }}document-normalizer/image-colour-mode.html?lang=python)
