...
description: API reference for the EnhancedImageResultItem class in Dynamsoft Document Normalizer .NET Edition, which represents a captured result item containing an enhanced document image.
