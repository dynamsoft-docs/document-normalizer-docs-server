...
description: API reference for the DeskewedImageElement class in Dynamsoft Document Normalizer .NET Edition, which represents a deskewed image element produced during document normalization.
